...
public enum Traits
{
    ...
    /// <summary>This unit recives fireball, poison, icicle, power bolt, or lightning bolt as innate spell.</summary>
    NaturalCaster = 536,
    /// <summary>This race increases the gold generated by it's village by 0.1% per population.</summary>
    Hoarder = 537,
    /// <summary>Units highest stat becomes favored and gains the following effect. Violent(Str): 5% Max HP Attack on 4turn CD; Excitable(Dex):+1 attack per turn for each level; Intrepid(Vor): Failed vore attempt grants increasing predation; Playful(Agi): +2 mov above 50%hp +10% Dodge below; 
