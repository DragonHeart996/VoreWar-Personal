...
static class TraitList
{
    ...
    static Dictionary<Traits, Trait> traits = new Dictionary<Traits, Trait>()
    {
        ...
        //[Traits.NaturalCaster] = new Booster("This unit recives fireball, poison, icicle, power bolt, or lightning bolt as innate spell.", (s) => { }),
        //[Traits.Hoarder] = new Booster("This race increases the gold generated by it's village by 0.1% per population.", (s) => {}),
        
        //personal edits
        //[Traits.SweepingSwallow] = new Booster("Grants SweepingSwallow Attack", (s) => { }),
        //[Traits.ExtremelyStretchy] = new Booster("Can attempt to eat anything so long as it has some space \n\n Also prevents overfeeding damage", (s) => {}),
    };
}
